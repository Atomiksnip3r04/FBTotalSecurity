...
const translations = {
    ...
    en: {
        ...
        'nav-lavora-con-noi': 'Work with Us',
        'nav-contatti': 'Contact',
        
        // Work with us section
        'lavora-con-noi-title': 'Work with Us',
        'lavora-con-noi-subtitle': 'Join our team of security experts',
        'lavora-con-noi-hero-title': 'Build Your Future in Security',
        'lavora-con-noi-hero-subtitle': 'Join FB Total Security and become part of an innovative reality in the security sector',
        'lavora-con-noi-hero-cta': 'Discover Positions',
        'lavora-con-noi-hero-cta1': 'Open Positions',
        'lavora-con-noi-hero-cta2': 'Apply Now',
        'lavora-con-noi-og-title': 'Work with Us - FB Total Security | Career Opportunities',
        'lavora-con-noi-twitter-title': 'Work with Us - FB Total Security | Career Opportunities',
        'lavora-con-noi-meta-description': 'Join the FB Total Security team. Career opportunities for sales agents, business procurers and telemarketing staff. Build your success in an innovative security startup.',
        'lavora-con-noi-og-description': 'Join the FB Total Security team. Career opportunities for sales agents and specialized staff. Build your success with us.',
        'lavora-con-noi-twitter-description': 'Join the FB Total Security team. Career opportunities for sales agents and specialized personnel.',
        'posizioni-aperte-title': 'Open Positions',
        'lavora-con-noi-call-now': 'Call Now',
        'lavora-con-noi-contact-us': 'Contact Us',
        'posizioni-aperte-subtitle': 'Career opportunities in the security sector',
        'posizione-agenti-title': 'Sales agents and business developers',
        'posizione-agenti-description': '<p>Build your success in an innovative security startup.</p><p>Are you a multi-mandate agent who is not afraid of challenges and is looking for an opportunity to grow? Join FB Security Solutions, an emerging reality in the security sector, created to redefine the concept of consulting.</p><p>Unlike traditional structures, we offer you the unique opportunity to be one of the first members of our team. This means not only working with an exclusive portfolio of four leading companies in the sector, but also having concrete career and growth opportunities within our expanding structure.</p><p>You will be the key to offering customers a tailor-made service, from armed surveillance to anti-theft and fog systems, from security grilles to the most innovative technological solutions. In return, we offer you a very competitive commission plan and the opportunity to grow with us.</p><p>If you are ready to put your experience at the service of an ambitious project, send your application. Those who believe in us first will have the best opportunities.</p>',
        'posizione-telemarketing-title': 'Personnel for telemarketing activities in smart working',
        'posizione-telemarketing-description': '<p>Build your success in an innovative security startup.</p><p>Are you a telemarketing professional who is not afraid of challenges and is looking for an opportunity to grow? Join FB Security Solutions, an emerging reality in the security sector, created to redefine the concept of consulting.</p><p>Unlike traditional structures, we offer you the unique opportunity to be one of the first members of our team. This means not only working with an exclusive portfolio of four leading companies in the sector, but also having concrete career and growth opportunities within our expanding structure.</p><p>You will be the key to offering customers a tailor-made service, from armed surveillance to anti-theft and fog systems, from security grilles to the most innovative technological solutions. In return, we offer you a very competitive commission plan and the opportunity to grow with us.</p><p>If you are ready to put your experience at the service of an ambitious project, send your application. Those who believe in us first will have the best opportunities.</p>',
        'job1-description': 'Build your success in an innovative security startup. Are you a multi-mandate agent who is not afraid of challenges and is looking for an opportunity to grow? Join FB Security Solutions, an emerging reality in the security sector, created to redefine the concept of consulting. Unlike traditional structures, we offer you the unique opportunity to be one of the first members of our team. This means not only working with an exclusive portfolio of four leading companies in the sector, but also having concrete career and growth opportunities within our expanding structure. You will be the key to offering customers a tailor-made service, from armed surveillance to anti-theft and fog systems, from security bars to the most innovative technological solutions. In return, we offer you a very competitive commission plan and the opportunity to grow with us. If you are ready to put your experience at the service of an ambitious project, send your application. The first to believe in us will have the best opportunities.',
        'job2-description': 'Build your success in an innovative security startup. Are you a telemarketing professional who is not afraid of challenges and is looking for an opportunity to grow? Join FB Security Solutions, an emerging reality in the security sector, created to redefine the concept of consulting. Unlike traditional structures, we offer you the unique opportunity to be one of the first members of our team. This means not only working with an exclusive portfolio of four leading companies in the sector, but also having concrete career and growth opportunities within our expanding structure. You will be the key to offering customers a tailor-made service, from armed surveillance to anti-theft and fog systems, from security bars to the most innovative technological solutions. In return, we offer you a very competitive commission plan and the opportunity to grow with us. If you are ready to put your experience at the service of an ambitious project, send your application. The first to believe in us will have the best opportunities.',
        'apply-text': 'Send your CV and a brief presentation',
        'why-choose-title': 'Why Choose FB Total Security',
        'why-choose-subtitle': 'The advantages of working with us',
        'benefit1-title': 'Professional Growth',
        'benefit1-desc': 'Concrete opportunities for growth in an expanding startup. You will be among the first members of the team with real and measurable career development possibilities.',
        'benefit2-title': 'Exclusive Portfolio',
        'benefit2-desc': 'Work with an exclusive portfolio of four leading companies in the security sector, with direct mandates and privileged partnerships.',
        'benefit3-title': 'Competitive Commission Plan',
        'benefit3-desc': 'Very competitive commission system that rewards merit and commitment, with the possibility of increasing earnings over time.',
        'contact-title': 'Apply Now',
        'contact-subtitle': 'Send your application and join our team',
        'contact-email-label': 'Email',
        ...
        'form-message': 'Presentation',
        'form-message-placeholder': 'Tell us about yourself and your experience...',
        'form-cv': 'Curriculum Vitae',
        'form-submit': 'Send Application',
        'form-select-position': 'Select a position',
        'form-option1': 'Sales agents and business developers',
        'form-option2': 'Personnel for telemarketing activities',
        'posizione-description': 'Build your success in an innovative security startup. Are you a multi-mandate agent who is not afraid of challenges and is looking for an opportunity to grow? Join FB Security Solutions, an emerging reality in the security sector, created to redefine the concept of consulting. Unlike traditional structures, we offer you the unique opportunity to be one of the first members of our team. This means not only working with an exclusive portfolio of four leading companies in the sector, but also having concrete career and growth opportunities within our expanding structure. You will be the key to offering customers a tailor-made service, from armed surveillance to anti-theft and fog systems, from security bars to the most innovative technological solutions. In return, we offer you a very competitive commission plan and the opportunity to grow with us. If you are ready to put your experience at the service of an ambitious project, send your application. The first to believe in us will have the best opportunities.',
        'perche-scegliere-title': 'Why Choose FB Total Security',
        'perche-scegliere-subtitle': 'The advantages of working with us',
        'vantaggio-1-title': 'Innovative Startup',
        'vantaggio-1-desc': 'Be part of an emerging reality with great growth opportunities',
        'vantaggio-2-title': 'Exclusive Portfolio',
        'vantaggio-2-desc': 'Work with four leading companies in the security sector',
        'vantaggio-3-title': 'Competitive Commission Plan',
        'vantaggio-3-desc': 'Earnings proportional to your results with advantageous conditions',
        'vantaggio-4-title': 'Professional Growth',
        'vantaggio-4-desc': 'Concrete career opportunities in an expanding structure',
        'candidatura-title': 'Send Your Application',
        'candidatura-subtitle': 'Fill out the form to apply for our open positions',
        'form-nome': 'Full Name',
        'form-email': 'Email',
        'form-telefono': 'Phone',
        'form-posizione': 'Position of Interest',
        'form-messaggio': 'Message (optional)',
        'form-cv': 'Upload your CV',
        'form-invia': 'Send Application',
        'form-privacy': 'I accept the processing of personal data according to the Privacy Policy',
        ...
        'service-serramenti-link': 'Security Grilles & Bars Milan',
        ...
        // Agency Section Translations
        'agency-title': 'Specialized Security Systems Agency',
        'agency-subtitle': 'FB Total Security - Leader in advanced protection sector',
        'agency-description': 'FB Total Security is a leading agency in the security sector, specialized in advanced protection systems, anti-theft fog systems and intelligent video surveillance. Our expertise includes European security certifications and implementation of innovative solutions for protecting homes and businesses throughout Italy.',
        'agency-feature-1': 'Specialization in advanced security systems',
        'agency-feature-2': 'European security certifications',
        'agency-feature-3': 'Innovative solutions for homes and businesses',
        'agency-feature-4': 'Service coverage throughout Italy',
        'agency-feature-5': 'Expertise in fog systems and intelligent video surveillance',
        'agency-cta': 'Contact Us',
        
        // Normative Section Translations
        'normative-title': 'Regulatory References and Certifications',
        'normative-subtitle': 'All our systems comply with the most rigorous European and Italian regulations',
        
        // European Regulations
        'normative-european-title': 'European Regulations',
        'normative-en-1627': 'European standards for anti-burglary grilles and bars',
        'normative-en-50131': 'Alarm systems for security applications',
        'normative-en-62676': 'CCTV video surveillance systems',
        'normative-cpr-305': 'Construction products regulation',
        
        // Italian Certifications
        'normative-italian-title': 'Italian Certifications',
        'normative-uni-10854': 'Pedestrian doors - Performance',
        'normative-dlgs-81': 'Safety in the workplace',
        'normative-privacy-code': 'D.Lgs. 196/2003 and GDPR',
        'normative-imq-csi': 'Product quality certifications',
        
        // Security Classes
        'normative-security-classes-title': 'Security Classes',
        'normative-rc-classes': 'Anti-burglary resistance classes',
        'normative-grade-levels': 'Alarm system levels',
        'normative-ip-protection': 'Camera environmental protection',
        'normative-ce-conformity': 'Mandatory European conformity',
        
        // Warranties and Compliance
        'normative-warranties-title': 'Warranties and Compliance',
        'normative-warranty-label': 'Warranty:',
        'normative-warranty-desc': '2-5 years on all products',
        'normative-support-label': 'Assistance:',
        'normative-support-desc': '24/7 technical support',
        'normative-installation-label': 'Installation:',
        'normative-installation-desc': 'Certified technicians',
        'normative-maintenance-label': 'Maintenance:',
        'normative-maintenance-desc': 'Assistance contracts',
        'normative-guarantee-main': '✓ All our products comply with current European and Italian regulations',
        'normative-guarantee-sub': 'Verifiable certifications • Standard installation • Guaranteed assistance',
        'nebbiogeni-app-2': 'Jewelry stores and goldsmiths',
        'nebbiogeni-app-3': 'Banks and credit institutions',
        'nebbiogeni-app-4': 'Pharmacies and parapharmacies',
        'nebbiogeni-app-5': 'Offices and professional studios',
        ...
        // Grate e Inferriate BlindatePage
        'serramenti-hero-title': 'Security Grilles & Bars',
        'serramenti-hero-subtitle': 'Latest generation security grilles and bars for doors and windows. Maximum physical protection with fixing systems without masonry work for your home and office.',
        ...
        'serramenti-types-title': 'Types of Security Grilles and Bars',
        'serramenti-types-description': 'We offer a complete range of armored grilles and security bars to meet every protection need, from residential to commercial, without masonry work.',
        'serramenti-type-1': 'Door grilles for homes',
        'serramenti-type-2': 'Door grilles for offices',
        'serramenti-type-3': 'Window security bars',
        'serramenti-type-4': 'Sliding grilles',
        'serramenti-type-5': 'Alice VI security grilles',
        'serramenti-type-6': 'Reinforced rolling grilles',
        ...
        'serramenti-partner-info-desc': 'Xecur Srl is a leading company in the production of armored grilles and bars and passive security systems. With over 30 years of experience, it guarantees the highest quality products certified according to the most severe European standards.',
        ...
        'chi-siamo-spec2-title': 'Security Grilles & Bars',
        'chi-siamo-spec2-desc': 'Latest generation armored grilles and bars. We design and install tailor-made solutions that combine maximum security and refined aesthetics for any type of environment.',
        ...
        'footer-info-privacy': 'Privacy Policy',
        'footer-info-cookies': 'Cookie Policy',
        'footer-info-service': 'Terms of Service',
        'footer-info-certifications': 'Certifications',
        'footer-info-business': 'Add your company for free',
        ...
        'clients-business-feature-3': 'Armored grilles and bars for banks and credit institutions',
        ...
        'clients-residential-feature-1': 'Armored grilles and bars for security doors',
        'clients-residential-feature-2': 'Fog systems for immediate protection',
        'clients-residential-feature-3': 'Custom armored grilles and bars for homes',
